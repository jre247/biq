...
{
	public class Html5DestinationAdResponse : IPlatformAdResponseService
	{
		#region Members
		...
		public Html5DestinationAdResponse(Ad ad, string targetEnv)
		{
			Ad = ad;
			TargetEnv = targetEnv;
		}
		...
		/// <summary>
		/// Get Ad Response for Destination and Html5 (Samsung or FireTv) combination
		/// </summary>
		/// <returns></returns>
