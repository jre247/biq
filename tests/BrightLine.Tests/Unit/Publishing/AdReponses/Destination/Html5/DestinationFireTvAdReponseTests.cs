...
{
	[TestFixture]
	public class DestinationFireTVAdReponseTests
	{
		#region Variables
		...
		[Test(Description = "(BL-629) Destination FireTV Ad Responses Count is correct")]
		...
		[Test(Description = "(BL-462) Destination FireTV Ad Response key is correct")]
		public void BrandDestination_FireTV_AdResponse_Key_Is_Correct()
		{
			// Act
			var service = new Html5DestinationAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
		...
		[Test(Description = "(BL-462) Destination FireTV Ad Response metadata is correct")]
		public void BrandDestination_FireTV_AdResponse_Metadata_Is_Correct()
		{
			// Act
			var service = new Html5DestinationAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
