...
{
	[TestFixture]
	public class OverlaySamsungAdReponseTests
	{
		#region Variables
		...
		public void Overlay_Samsung_AdResponse_Key_Is_Correct()
		{
			// Act
			var service = new Html5DestinationAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
		...
		public void Overlay_Samsung_AdResponse_Metadata_Is_Correct()
		{
			// Act
			var service = new Html5DestinationAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
