...
{
	[TestFixture]
	public class OverlayFireTVAdReponseTests
	{
		#region Variables
		...
		[Test(Description = "(BL-629) Overlay FireTV Ad Responses Count is correct")]
		public void Overlay_Html5_AdResponses_Count_Is_Correct()
		{
			// Act
			var service = new Html5OverlayAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();

			// Assert
			Assert.IsNull(adResponses.AdResponseBody.Default, "Ad Responses Default should be null.");
		...
		[Test(Description = "(BL-462) Overlay FireTV Ad Response key is correct")]
		public void Overlay_FireTV_AdResponse_Key_Is_Correct()
		{
			// Act
			var service = new Html5OverlayAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
		...
		[Test(Description = "(BL-462) Overlay FireTV Ad Response metadata is correct")]
		public void Overlay_FireTV_AdResponse_Metadata_Is_Correct()
		{
			// Act
			var service = new Html5OverlayAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
		...
		private void SetupObjectGraph()
		{
			...
			Ad = new Ad
			{
				...
				DestinationAd = new Ad { Id = DestinationAdId },
