...
{
	[TestFixture]
	public class CommercialSpotSamsungAdReponseTests
	{
		#region Variables
		...
		[Test(Description = "(BL-629) Commercial Spot Samsung Ad Responses Count is correct")]
		...
		[Test(Description = "(BL-462) Commercial Spot Samsung Ad Response key is correct")]
		public void CommercialSpot_Samsung_AdResponse_Key_Is_Correct()
		{
			// Act
			var service = new Html5CommercialSpotAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
		...
		[Test(Description = "(BL-462) Commercial Spot Samsung Ad Response metadata is correct")]
		public void CommercialSpot_Samsung_AdResponse_Metadata_Is_Correct()
		{
			// Act
			var service = new Html5CommercialSpotAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
		...
		[Test(Description = "(BL-462) Commercial Spot Samsung Ad Response Poco is correct")]
		public void CommercialSpot_Samsung_AdResponseData_VAST_Xml_Is_Correct()
		{
			// Act
			var service = new Html5CommercialSpotAdResponse(Ad, TargetEnv);
			var adResponses = service.GetAdResponse();
