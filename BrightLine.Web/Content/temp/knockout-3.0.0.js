	...
	(function (undefined) {
		...
		(function (factory) {
				...
				ko.utils.extend(ko.bindingProvider.prototype, {
					...
					'parseBindingsString': function (bindingsString, bindingContext, node, options) {
						try {
							...
							if (this.DEBUG && (console && console.log && typeof (console.log) === "function")) console.log(ex.Message);
							throw ex;
						}
					}
				});
			...
			(function () {
				...
				ko.applyBindings = function (viewModelOrBindingContext, rootNode, callback) {
					// If jQuery is loaded after Knockout, we won't initially have access to it. So save it here.
					if (!jQuery && window['jQuery']) {
						jQuery = window['jQuery'];
					}

					if (rootNode && typeof (rootNode) == typeof (Function)) {
						callback = rootNode;
